...
function setup() {
  ...
  for (var i = 0; i <= 10; i++){
    ...
    triangle(random(window.innerWidth*4),random(window.innerHeight*2),random(window.innerWidth*4),random(window.innerHeight*2),random(window.innerWidth*4),random(window.innerHeight*2))
  }
}
